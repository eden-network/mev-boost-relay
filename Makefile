...
docker-image:
	DOCKER_BUILDKIT=1 docker build --platform linux/amd64 --build-arg VERSION=${VERSION} . -t edennetwork/mev-boost-relay

docker-image-local:
	DOCKER_BUILDKIT=1 docker build --build-arg VERSION=${VERSION} . -t edennetwork/mev-boost-relay